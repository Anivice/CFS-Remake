...
std::string cfs::utils::PreDefinedArgumentType::print_help() const
{
    struct arg_show_t {
        std::string name;
...
bool cfs::utils::ParsedArgumentType::contains(const signed char c) const noexcept
{
...
bool cfs::utils::ParsedArgumentType::contains(const std::string &str) const noexcept
{
    return std::ranges::any_of(arguments_, [&](const args_parsed_t & arg) ->bool {
...
std::string cfs::utils::ParsedArgumentType::at(const char c) const
{
