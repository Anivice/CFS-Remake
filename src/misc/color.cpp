...
std::string cfs::color::no_color() noexcept
{
    if (!is_no_color()) {
        return "\033[0m";
    }
...
std::string cfs::color::color(int r, int g, int b) noexcept
{
    if (is_no_color()) {
        return "";
    }
...
std::string cfs::color::bg_color(int r, int g, int b) noexcept
{
    if (is_no_color()) {
        return "";
    }
...
std::string cfs::color::color(const int r, const int g, const int b, const int br, const int bg, const int bb) noexcept
{
    if (is_no_color()) {
        return "";
    }
